...
Need to go to ~/Dropbox/MY_Website/WordPresser.R

# Hopstat Blog

Here are the posts of the RMD files from my website. Hopefully it’s a
good idea. So if you want to run anything, just tangle out the code
using `knitr`.
...
| [Getting the EPA Walkability Index in R](Getting_the_EPA_Walkability_Index_in_R/index.html) | [Rmd](Getting_the_EPA_Walkability_Index_in_R/Getting_the_EPA_Walkability_Index_in_R.Rmd) |
...
| [PMI: The Loan with an Increasing Interest Rate](PMI__The_Loan_with_an_Increasing_Interest_Rate/index.html) | [Rmd](PMI__The_Loan_with_an_Increasing_Interest_Rate/PMI__The_Loan_with_an_Increasing_Interest_Rate.Rmd) |
...
| [Some things I wish I knew about Grad School](Some_things_I_wish_I_knew_about_Grad_School/index.html) | [Rmd](Some_things_I_wish_I_knew_about_Grad_School/Some_things_I_wish_I_knew_about_Grad_School.Rmd) |
| [Some Thoughts as a Junior Faculty (at JHSPH)](Some_Thoughts_as_a_Junior_Faculty_(at_JHSPH)/index.html) | [Rmd](Some_Thoughts_as_a_Junior_Faculty_(at_JHSPH)/Some_Thoughts_as_a_Junior_Faculty_(at_JHSPH).Rmd) |
...
| [The 3 ‘Times’ of a Project](The_3_Times_of_a_Project/index.html) | [Rmd](The_3_Times_of_a_Project/The_3_Times_of_a_Project.Rmd) |
